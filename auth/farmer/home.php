...
session_start();
  ...
  include "./class/farmer_function.class.php";
$obj = new Admin;
?>
        ...
        if (isset($site)) {
            switch ($site) {
                case 'main':
                    ...
                    break;
                case 'add_product':
                    include "./includes/add_product_content.php";
                    break;

                     case 'product-view':
                    include "./includes/product_view_content.php";
                    break;


                case 'project':
                    include "./includes/project_content.php";
                    break;
                    case 'profile_pic':
                        include "./includes/profile_pic_content.php";
                        break;

  ;
             case 'parent_category':
                    include "./includes/parent_category_content.php";
                    break;
