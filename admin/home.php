 ...
 <?php
        if (isset($site)) {
            switch ($site) {
             ...
             case 'farmer':
                    include "./includes/farmer_content.php";
                    break;
                    case 'add_blog':
                ...
                case 'check-product':
                    include "./includes/check_product_content.php";
                    break;

                    case 'dhaka':
                        include "./includes/Bajardor/dhaka_content.php";
                        break;
                    case 'comment':
                        include "./includes/comment_content.php";
                        break;
